...
### Question 4: Is B a Good Choice on a Multiple-Choice Exam?
...
$$
z=\frac{\text { Sample statistic }- \text { Null paramete }}{S E}=\frac{\widehat{p}-p_0}{\sqrt{\frac{p_0\left(1-p_0\right)}{n}}}=\frac{0.225-0.20}{\sqrt{\frac{0.2(0.8)}{400}}}=  1.25 .
$$
**The p-value**
...
We see that the p -value is $2(0.01056)=$ 0.2112

This p-value leads us to fail to reject $H_{\mathrm{O}}$. We could not find strong evidence to onclude that the proportion of smokers is not $20 \%$.


$\\$


### Question 5 : Incentives for Quitting Smoking: Do They Work?
