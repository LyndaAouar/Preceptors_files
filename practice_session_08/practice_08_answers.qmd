...
If the  sample size is reasonably large so that $n p_{0} \geq 10$, then we can test $H_{0}: p=p_{0}$ vs $H_a: p \neq p_{0}$ (or a one-tail alternative), and the standardized test statistic is: 
