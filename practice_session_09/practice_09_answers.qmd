...
**If the disease is dangerous, then a Type 2 error (saying a patient doesn't have the disease when they really do) can be a big issue. We would want to make the Type 2 error lower. However, this may make the Type 1 error larger as a result.**
